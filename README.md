...
## Since the website is still in the test stage, the related functions are not yet perfect. Introduction only introduces the use of stock and foreign exchange two main functions.
...
## Also, when the investor clicks on the currency icon, investors can see real-time quotes between foreign exchanges and advice from foreign exchange experts on foreign exchange trading.
